                            ...
                            @endforeach
                             ...
                             <!-- New fields on the region -->
                                <div class="form-group{{ $errors->has('system_cost') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" required step="any" required min="0" name="system_cost" id="input-system_cost" class="form-control{{ $errors->has('system_cost') ? ' is-invalid' : '' }}" placeholder="{{ __('6000') }}" value="{{ old('name', $organization->system_cost) }}"  autofocus>
                                ...
                                <div class="form-group{{ $errors->has('system_size') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" step="any" required min="1" max="10" name="system_size" id="input-system_size" class="form-control{{ $errors->has('system_size') ? ' is-invalid' : '' }}" placeholder="{{ __('5') }}" value="{{ old('name', $organization->system_size) }}"  autofocus>
