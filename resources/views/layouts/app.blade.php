...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="{{ $class ?? '' }}">
        @auth()
            ...
            @if (auth()->user()->isAdmin() && !in_array(request()->route()->getName(), ['home', 'welcome', 'invitation.create', 'invitation.store', 'page.pricing', 'page.reporting', 'page.cluster_reporting', 'page.privacy', 'page.lock', 'page.pdf', 'page.faq', 'page.building']))
